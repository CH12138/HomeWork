            ...
            >
                ...
                >
                    ...
                    <Menu.Item key={"/app/form"}>
                        <Link to={"/app/form"}><Icon type="form" /><span>客户信息</span></Link>
                    </Menu.Item>

                    <Menu.Item key={"/app/form1"}>
                        <Link to={"/app/form1"}><Icon type="form" /><span>交易信息</span></Link>
                    </Menu.Item>
                    <SubMenu key="/app/chart" title={<span><Icon type="area-chart" /><span>图表</span></span>}>
